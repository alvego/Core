...
------------------------------------------------------------------------------------------------------------------
function ns.TimerMore(name, more) -- Возвращает true если с момента запуска таймера name прошло более more секунд
  return ns.TimerStarted(name) and ns.TimerElapsed(name) > (more or 0)
end
------------------------------------------------------------------------------------------------------------------
